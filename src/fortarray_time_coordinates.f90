module fortarray_time_coordinates
    use iso_fortran_env, only: int32, int64, real32, real64, error_unit
    use fortarray_types
    use fortarray_storage
    use fortarray_datasets
    use fortarray_constructors, only: create_coordinate
    implicit none
    private
...
contains
    ...
    function has_valid_time_bounds(time_var, bounds_var) result(is_valid)
        type(fortarray_t), intent(in) :: time_var, bounds_var
        logical :: is_valid
...
end module fortarray_time_coordinates