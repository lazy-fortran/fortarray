module fortarray_boolean_indexing
    use fortarray_types
...
contains
    ...
    function where_mask_only(mask, var) result(result)
        type(fortarray_t), intent(in) :: mask, var
    ...
    function where_mask_with_fill_variable(mask, var, fill_var) result(result)
        type(fortarray_t), intent(in) :: mask, var, fill_var
        type(fortarray_t) :: result
        integer :: i
    ...
    function where_broadcast(mask, var) result(result)
        type(fortarray_t), intent(in) :: mask, var
        type(fortarray_t) :: result
        type(fortarray_t) :: expanded_mask
    ...
    function apply_mask(var, mask) result(result)
        type(fortarray_t), intent(in) :: var, mask
        type(fortarray_t) :: result
...
end module fortarray_boolean_indexing